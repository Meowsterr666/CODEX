...
# I think, I worked out the instructions right.. ‹’’›(Ͼ˳Ͽ)‹’’›
...
# Store the option buttons and their rectangles in OPTIONS.
        ...
        while True: # main game loop
                ...
                msg = 'This did not have instructions' # contains the message to show in the upper left corner.
...
event.pos[1])
                                # print(event.pos); # Leave for later
